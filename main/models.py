...
class Doctor(models.Model):
    ...
    avatar = models.ImageField(
        upload_to="main/doctor/avatar/", verbose_name="Аватар", **NULLABLE
    )
    ...
    def __str__(self):
        return (
            f"{self.first_name} {self.last_name} {self.surname} ({self.specialization})"
        )
...
class Services(models.Model):
    ...
    photo = models.ImageField(
        upload_to="main/services/photo/", verbose_name="Фото", **NULLABLE
    )
...
class Appointment(models.Model):
    services = models.ForeignKey(
        Services, on_delete=models.CASCADE, verbose_name="Услуги"
    )
    doctor = models.ForeignKey(Doctor, on_delete=models.CASCADE, verbose_name="Доктор")
